...
//###############################################################################################################
       string s1= "10.1.1.";
      for(int node_index =1 ; node_index<nNode; node_index++)
      {
        ...
        Ipv4Address eachNodeAddress =str;
        dsr->DeleteAllRoutesIncludeLink (eachNodeAddress, unreachNode,ipv4Address);
         dsr->DeleteAllRoutesIncludeLink (errorSrc, unreachNode,eachNodeAddress);
...
//###############################################################################################################
      ...
      for(int node_index =1 ; node_index<nNode; node_index++)
      {
        ...
        Ipv4Address eachNodeAddress =str;
        dsr->DeleteAllRoutesIncludeLink (eachNodeAddress, unreachAddress,ipv4Address);
         dsr->DeleteAllRoutesIncludeLink (errorSource, unreachAddress,eachNodeAddress);
      }
// ############################################################################################################## saikat
                // ****** 1st Modified End
//###############################################################################################################
